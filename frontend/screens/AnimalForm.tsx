...
const AnimalForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
        const result : any = await saveAnimal(formData, animalId);
        const newAnimalId = result.data?._id || animalId;
        setMessage(result.message);
        navigation.navigate('AnimalDetails', { animalId: newAnimalId, updated: true });
    } catch (err: any) {
